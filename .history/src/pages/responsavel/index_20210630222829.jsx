...
export default function Responsavel(props){
    ...
    const {listaDeItems, listen, setListen} = useGetDatas('responsaveis-Tecnicos')responsaveis-tecnicos

    function writeRotulo(responsavel) {
        if(responsavel){
            firebase.database().ref('responsaveis-Tecnicos/'+ responsavel).set({
