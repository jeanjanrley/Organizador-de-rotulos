        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="contra-rotulo">
                    ...
                    <button onClick={() => {getRandomEan13(); writeRotulo(categoria, fragrancia, medida, lote, data, validade, responsavel, contraRotulo, codigoDeBarras)}} type="button">Enviar</button>
                </div>
