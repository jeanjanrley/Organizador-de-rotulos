        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="filterArea">
                    <Filter placeholder="Ex: 'Sabonete liquido..'" title="Categoria" setState={setCategoria} value={categoria} rota="22222"/>
                    <Filter placeholder="Ex: 'Lavanda..'" title="Fragrancia" setState={setFragrancia} value={fragrancia} rota="adfaf"/>
