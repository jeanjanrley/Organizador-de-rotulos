...
export default function Home(){
    ...
    function writeRotulo(categoria, fragrancia, volume, data, contraRotulo) {
        firebase.database().ref('contra-rotulos/' + `${categoria}  + fragrancia + volume`).set({
          categoria: categoria,
        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="contra-rotulo">
                    ...
                    />
                    <button onClick={() => alert(categoria + fragrancia + volume + data + contraRotulos + contraRotulo)} type="button">Enviar</button>
                </div>
