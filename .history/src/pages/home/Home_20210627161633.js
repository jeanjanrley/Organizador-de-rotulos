        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="filterArea">
                    ...
                    <Filter title="Categoria" setState={setCategoria} value={fragrancia}/>
                    <Filter title="Categoria" setState={setCategoria} value={volume}/>
                    <Filter title="Categoria" setState={setCategoria} value={data}/>
                </div>
