        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="filterArea">
                    <Filter placeholder="Ex: 'Sabonete liquido..'" title="Categoria" setState={setCategoria} value={categoria} origem="categorias"/>
                    <Filter placeholder="Ex: 'Lavanda..'" title="Fragrancia" setState={setFragrancia} value={fragrancia} origem="fragrancia"/>
