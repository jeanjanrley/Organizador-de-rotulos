...
export default function Home(){
    ...
    const [contraRotulo, setContraRotulo] = 
        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="contra-rotulo">
                    ...
                    <input onChange={(event) => setContraRotulo(event.target.value)} list="contra-rotulos" className="filter-rotulo"/>
                    ...
                    <textarea/>
                    <button onClick={() => alert(categoria + fragrancia + volume + data)} type="button">Enviar</button>
                </div>
