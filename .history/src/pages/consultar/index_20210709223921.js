...
import Medida from '../../components/filter/index'
        ...
        <div className="Page">
            ...
            <main className="Home">
                ...
                <div className="filterArea">
                    <Filter title="Categoria" placeholder="Ex: Sabonete liquido" rota="categorias"/>
                    <Filter title="Fragrancia" placeholder="Ex: Cereja e aveia" rota="fragrancias"/>
                    <Filter title="Volume" type="number"/>
                    <Filter title="Res. Tecnico" placeholder="Quimico(a) Responsável" rota="responsaveis-tecnicos"/>
                </div>
