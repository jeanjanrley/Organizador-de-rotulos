...
export default function ContraRotulo(props){
    ...
    function codeEan13(numero){
        ...
        const codigoNum = parseInt(codigoDeBarras)
        ...
        return(const digitoVerificador = ((Math.trunc(total / 10) + 1) * 10) - total)
            ...
            <div className="codigo-de-barras">
                ...
                <div className="boxs-area">
                    ...
                    <div className="camp-codigo-de-barras camp2">
                        ...
                        <button id="codigoDeBarrasInput"className='first-button' onClick={() => {setCodigoDeBarras(inputCodigoDeBarras); codeEan13()}}>gerar codigo de barras</button>
