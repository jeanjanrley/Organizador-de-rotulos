...
export default function ContraRotulo(props){
    ...
    const [codigoDeBarras, setCodigoDeBarras] = useState(inputCodigoDeBarras)
            ...
            <div className="codigo-de-barras">
                ...
                <div className="boxs-area">
                    ...
                    <div className="camp-codigo-de-barras camp2">
                        ...
                        <button id="codigoDeBarrasInput"className='first-button' onClick={() => alert('funcionando')}>gerar codigo de barras</button>
