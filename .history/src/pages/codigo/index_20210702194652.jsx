...
export default function ContraRotulo(props){
    const [condigoDeBarras, setCodigoDeBarras] = useState(0000000000000)
            ...
            <div className="codigo-de-barras">
                ...
                <div className="boxs-area">
                    ...
                    <div className="camp-codigo-de-barras camp2">
                        <input onChange={(event) => setCodigoDeBarras(event.ta)}placeholder="Digite o nº do codigo de barras" type="text" />
