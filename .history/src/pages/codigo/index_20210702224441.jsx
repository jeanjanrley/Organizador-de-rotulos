...
export default function ContraRotulo(props){
    ...
    function codeEan13(){
        const codigo = codigoDeBarras.split('')
        var [contador, setContador = useState('0000000000000')
        const multiplos = codigo.map((caracter) => {
            if (contador == true){
                return caracter * 1}
            ...
            <div className="codigo-de-barras">
                ...
                <div className="boxs-area">
                    ...
                    <div className="camp-codigo-de-barras camp2">
                        <input type="text" maxlength="3" onChange={(event) => setInputCodigoDeBarras(event.target.value)}  placeholder="Digite o nº do codigo de barras"/>
